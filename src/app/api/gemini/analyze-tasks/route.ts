    ...
    async start(controller) {
      try {
        ...
        const analysisPrompt = `
          ...
          ${useThinkingModel ? 
            'Include your detailed reasoning in the "reason" field for each group of tasks. Be thorough in explaining why tasks should be merged or kept separate. use <HTML> format.' : 
          ...
          Format your response ONLY as a valid JSON object conforming to this structure (do not include any extra text or markdown formatting like \`\`\`json). For details use <HTML> format:
